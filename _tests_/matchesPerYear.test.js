const matchesPerYear = require('../src/server/matchesPerYear').numberOfMatchesPerYear;
const fs = require('fs');
...
test('data generated should match the test data', () => {
    const testData = { "2008": 58, "2009": 57, "2010": 60, "2011": 73, "2012": 74, "2013": 76, "2014": 60, "2015": 59, "2016": 60, "2017": 59 };
    matchesPerYear((err, data) => {
